...
\begin{equation}
\boldsymbol{\alpha=v},\alpha\in\left[0,NB\right]
\end{equation}


\begin{equation}
\boldsymbol{\beta=N\times\frac{t_{win}+\frac{1}{NB\times t_{MAX}+1}}{\frac{t_{win}}{v+1}+1}},\beta\in\left[0,N\right],t_{win}\in\left[0,N\times t_{MAX}\right]
\end{equation}


\begin{equation}
\boldsymbol{\gamma=\frac{t_{defeated}}{NB\times t_{MAX}+1}},\gamma\in\left[0,1\right],t_{defeated}\in\left[0,N\times t_{MAX}\right]
\end{equation}
