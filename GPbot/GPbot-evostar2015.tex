...
% Antonio - Yo introduciría el entorno del problema mejor. No todos los lectores sabrán qué quiere decir o e qué consiste 'the evolutionary process in the design of a game bot'... Lo he hecho con una frase al principio. ;)
...
% Antonio - 'make sure' es como si el juego se asegurase de eso. Al diseñar un juego no creo que se piense mucho en esta posibilidad. ;D
 that there is no single best way of creating a bot that defeats all enemies; once it is found, there is no challenge left. 
% Antonio - repito, esto no es algo de lo que los diseñadores del juego se preocupen
...
% Antonio - he reescrito un poco esto. Los individuos no cambian, cambia su evaluación. Lo he dejado más o menos igual, aunque creo que mejor expresado en este sentido.
