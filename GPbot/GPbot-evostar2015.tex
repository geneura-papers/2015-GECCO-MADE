...
In this scope, Evolutionary Algorithms (EAS) are usually applied to find the best autonomous
agent for playing the game, i.e. the best \textit{bot}
\cite{Agent_Smith_CEC2009,Mora-Evo2010,Esparcia10FPS,FernandezAres2012adaptive}.
