...
As it can be also seen in the figure all the criterion are well defined, since all the scores grow in every criterion block. The score function is working well even with the presence of noise (a fact shown by the wide of the boxplots). ***
