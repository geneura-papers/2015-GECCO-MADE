...
\begin{itemize}
    \item \texttt{[NG] Number of generations}  is the classical termination
      criteria in evolutionary algorithms. We will consider 30, 50 and 100 generations since some papers \cite{EvoStar2014:GPBot} have mentioned the middle value. As indicated in the previous section,
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{imags/Boxplot_SC-Score.eps}
\end{center} 
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{imags/Boxplot_SC-Generations.eps}
\end{center} 
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{imags/Comparative.eps}
\end{center} 
