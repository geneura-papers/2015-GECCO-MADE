...
\end{center} 
\caption{Scores of the best individuals (of all runs), grouped by termination criterion and Kruskal-Wallis test of populations of each criterion by score (black means no statistical difference)}
...
\end{center} 
\caption{Generation attained (of all runs), grouped by termination criteria and Kruskal-Wallis test of populations of each stop criterion by generations (black means no statistical difference)}
