...
Figure \ref{fig:boxplotscore} shows the scores obtained by the best individuals yielded for every stop criterion.

\begin{figure}
\begin{center}
\includegraphics[width=\columnwidth]{imags/Boxplot_SC-Score-log.eps}
\end{center} 
\caption{Scores of the best individuals (of all runs), grouped by termination criterion.}
...
\begin{figure}[h!tb]
\begin{center}
\includegraphics[width=0.32\columnwidth]{imags/Comparative-log.eps}
\includegraphics[width=0.32\columnwidth]{imags/Kruskal-Score.eps}
\includegraphics[width=0.32\columnwidth]{imags/Kruskal-Generations.eps}
\end{center} 
