...
Because there is not a fitness function to measure the quality of a generated bot, a scoring method is proposed. This scoring method tries to reduce the effects of the noisy
evaluation (following the guidelines of other works \cite{DBLP:journals/jcst/MoraFGGF12}) by computing fitness from the result of
30 matches against an expert rival, 
...
Each individual has been tested 30 times in different maps, therefore $N=30$, 
...
\end{center} 
\caption{Mean best individual score versus mean atained generations by each termination criteria.}
