...
\caption{Comparative of each criterion with tree measure: (G) Number of generations, (S) Score, (R) Completion rate in experiments and (V) Victories versus several bots in several maps. Relative measure by \textit{NG\_30.0}.}
\label{fig:table}
\end{minipage}
\end{figure}
