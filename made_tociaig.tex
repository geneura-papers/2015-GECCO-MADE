...
goals or
provide realism and aliveness \notajj{¿Esto existe? ¿life-likeness no
  sería mejor?}
 to the virtual world. In open worlds\notajj{Tienes que definir open worlds}
...
are also emergent. However, this methodology for the emergence of
backstories  did not use formal models to
define the archetypes or the facts \notajj{No me gusta facts. Actions?}
 of the virtual world and no {\em a priori} rules
could be provided to establish whether or not a design of an agent
could lead to the appearance of the archetypes. \notajj{Explica, con
  un ejemplo, quizá}
