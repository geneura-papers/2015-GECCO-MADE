...
agents and found out that the existence of conflicts is essential %en ese "and" yo pondr’a un punto y partir’a la frase tan larga en dos...   [Pedro]
...
For this reason in the present paper we formally model the archetypes using predicate logic. 
...
%una œltima frase (antes de comentar la estructura del paper) diciendo quŽ esperamos obtener al modelar formalmente los arquetipos con l—gica de predicados. Una especie de s’ntesis un una frase para que al lector le quede claro lo que pretendemos hacer y para quŽ.
