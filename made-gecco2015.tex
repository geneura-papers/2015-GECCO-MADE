...
% IMPORTANTE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
\notaimportante{Importante, esta sección está WIP. Salvo que sean dudas, no leer ni revisar. Cuando la tenga lista (hoy), asignaré revisor}
...
\notaruben{WIP: Aquí hablaré del modelo de capas que dibujé}
...
\notafergu{Resumiendo, hay que vender lo de los predicados bien y con referencias chulas}
...
\notaruben{Reeescribir esto, que está sacado de www.thewritersjourney.com} %http://www.thewritersjourney.com/hero %27s_journey.htm
...
\notafergu{enlaza la lista anterior con lo siguiente: Ejemplo: This amount of archetypes need to be represented as PATATIN as possible POR TAL y TAL, therefore we propose}
