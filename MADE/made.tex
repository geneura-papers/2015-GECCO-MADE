...
%TODO Optimizacion de MAS mediante GAS (articulo Evolutionary computation and agent-based modeling: biologically-inspired approaches for understanding complex social systems)
...
%TODO Elementos basicos para generacion de tramas: Enganchar con Morrell \cite{MorrellFiction06}
...
using GAs was presented by GarcÃ­a-Ortega et al. in \cite{garcia14my}. In that
...
does not follow a normal distribution a non-parametric test, the Kruskalâ€“Wallis test, has been
performed.  % por
