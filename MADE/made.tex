...
growth (1/8 of the number of cells), the lower number of profiles (1) and the bigger population size of the GA (256). This is due to the fact that the three possible archetypes emerge when a the fights occur, and that happens more probably when the world is small and there is little food. Anyway, the backstories size increase with the virtual days of execution, thus it is easier to find archetypes when there are more. This can be generalised to similar problems (and the rest of scenarios): the source of conflict should be forced to occur more times, and simultaneously, it is necessary to give enough time to these situations appear.
