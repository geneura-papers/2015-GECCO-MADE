...
\author{R.~H. Garc\'ia-Ortega\inst{1,2} \and P. Garc\'ia-S\'anchez\inst{1} \and J.~J. Merelo\inst{1} \and M.~I.~ Garc\'ia~ Arenas\inst{1} \and  P.~A.~ Castillo\inst{1} \and A.~M. Mora\inst{1}}

\authorrunning{R.~H. Garc\'ia Ortega et al.}

\institute{Dept. of Computer Architecture and Technology, University of Granada, Spain
\and Fundaci\'on I$+$D del Software Libre - Fidesol, Granada, Spain}
...
{\em profiles} (different types of finite state automata present) had a big influence on the outcome, to the point of making
...
obtain the agents' life story that better fits the goals described by the user/author before the world is generated. It follows the methodology presented in \cite{garcia14my}: systematise the generation of backstories in massive worlds, defining the elements of a complex world, and optimise the characters' behaviour using GAs to extract information.
...
%FERGU: Este párrafo que sigue no tiene ni pies ni cabeza, fuera :/
